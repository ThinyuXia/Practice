        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <router-link class="nav-link active" aria-current="page" :to="{ name: 'home', params: {} }">首页
                        </router-link>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav" v-if="!$store.state.user.is_login">
                    <li class="nav-item">
                        <router-link class="nav-link" aria-current="page" :to="{ name: 'login', params: {} }">登陆
                        </router-link>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav" v-else>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" :to="{ name: 'register', params: {} }" style="cursor: pointer"
                            @click="logout">退出</a>
                    </li>
                </ul>
            </div>
