...
import com.xiaxinyu.mybatis.dao.GoodsDAO;
...
//            List<Goods> goodsList = sqlSession.selectList("goods.selectByPriceRange",param);
            List<Goods> goodsList = goodsDAO.selectByPriceRange(100f,500f,100);
    ...
    public void testSelect(){
        ...
        try{
            ...
            List<Goods> list = page.getResult(); //获得当前页数据
            for(Goods goods : list){
                System.out.println(goods.getTitle());
            }
