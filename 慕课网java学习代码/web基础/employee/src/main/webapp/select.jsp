        ...
        <div class="panel panel-default">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>${requestScope.result.ename}</td>
                    <td>${requestScope.result.department}</td>
                    <td>${requestScope.result.job}</td>
                    <td style="color: red;font-weight: bold"><fmt:formatNumber value="${requestScope.salary}" pattern="0,000.00"></fmt:formatNumber></td>
                </tr>
