...
<body>
	...
	<div class="header">
		...
		<div class="menu"   onclick="show_menu()" onmouseleave="show_menu1()">
			 ...
			 <ul id="title">
				<li>
				<a href="/page?c=${1}">现实主义</a>
				</li>
				<li>
				<a href="/page?c=${2}">抽象主义</a>
				</li>
			 </ul>
		</div>
		<div class="auth">
	...
	<div class="content">
	  ...
	  <div class="page-nav">
		<ul>
			...
			<c:forEach begin="1" end="${pageModel.totalPages}" var="pnum" step="1">
				<li><span ${pnum==pageModel.page ? "class='first-page'":""}>
					<a href="/page?p=${pnum}${categoryParam}">${pnum} </a>
				</span></li>
			</c:forEach>
